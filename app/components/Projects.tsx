...
export default function Projects() {
  return (
    <section className="grid grid-cols-project h-[940px] px-[170px] py-[50px] ">
      <div className="flex flex-col gap-y-10">
        <div className="flex">
          <div className="flex flex-col gap-y-4 text-black bg-white border-2 border-black rounded-lg h-[250px] w-[650px] py-4 px-10">
            <h1 className="font-bold text-[30px]">PORTFOLIO</h1>
            <p className="text-[18px]">My Personal Portfolio</p>
            <ul className="flex flex-wrap w-[300px] gap-x-2 gap-y-2">
