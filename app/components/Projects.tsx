...
export default function Projects() {
  return (
    <section className="flex gap-x-4 flex-col-reverse gap-y-8 md:grid grid-cols-project h-full px-[50px] md:px-[20px] lg:px-[170px] py-[50px] ">
      <div className="flex flex-col gap-y-10">
        <div className="flex">
          <div className="flex h-[450px] md:h-[350px] flex-col justify-start items-center md:items-start gap-y-4 text-black bg-white border-2 border-black rounded-lg lg:h-[250px] w-[650px] py-4 px-10">
            ...
            <ul className="flex flex-wrap w-[300px] gap-x-2 gap-y-2 justify-center items-center md:justify-start md:w-[200px]">
